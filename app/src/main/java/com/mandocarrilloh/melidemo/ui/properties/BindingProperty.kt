package com.vomerc.vomerc.properties
...
fun <T : ViewDataBinding> activityBinding(@LayoutRes resId: Int): ReadOnlyProperty<Activity, T> = object : BindingProperty<Activity, T>() {
...
fun <T : ViewDataBinding> fragmentBinding(@LayoutRes resId: Int): ReadOnlyProperty<Fragment, T> = object : BindingProperty<Fragment, T>() {
